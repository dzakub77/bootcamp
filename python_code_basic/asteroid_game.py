...
class Asteroid(Wrapper):
    ...
    def die(self):
        """Zniszczenie asteroidy"""
        Asteroid.total -= 1

        self.game.score.value += int(Asteroid.POINTS / self.size)
        self.game.score.right = games.screen.width - 10
        # jesli nie jest to mala ateroida zastap ja dwoma mnijeszymi
...
class Ship(Collider):
    ...
    def update(self):
        ...
        if games.keyboard.is_pressed(games.K_UP):
            Ship.sound.play()
            # zmiana składowych prędkości w zależności od kąta położenia
            angle = self.angle * math.pi / 180  # zamieniam na radiany ponieważ moduł math wymaga tego
...
class Game(object):
    def __init__(self):
        ...
        #załadowanie dzwieki na podniesienie poziomu
    ...
    def play(self):
        ...
        mgla_image = games.load_image('mglawica.jpg')
        games.screen.background = mgla_image
